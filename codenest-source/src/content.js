    ...
    items: [
      {
        ...
        company: "敷尔佳科技股份有限公司",
        meta: "上市公司 / 平面设计师",
        logo: "./portfolio/career-volga.jpg",
        responsibilities:
        ...
        moreDetails:
          "围绕主图、商品卡、平台会场与线下物料建立持续复盘机制，根据销售与转化表现调整视觉优先级，让品牌统一性、内容效率与商业增长同时成立。",
      },
      {
        index: "02",
        ...
        logo: "./portfolio/career-japan.jpg",
        responsibilities:
        ...
        moreDetails:
          "一端将日本品牌叙事转译为中国受众可理解的视觉内容，另一端参与中日企业沟通、商务资料与项目推进，在设计咨询和经营协作之间建立完整视角。",
      },
      {
        index: "03",
        ...
        company: "福瑞达生物股份有限公司",
        meta: "国企 / 平面设计师",
        logo: "./portfolio/career-freda.jpg",
        responsibilities:
        ...
        moreDetails:
          "从活动主题、新媒体内容到线下终端建立统一规范，通过模板化、组件化与资产复用降低跨团队协作成本，并提升高频营销内容的交付稳定性。",
      },
      {
        index: "04",
        ...
        meta: "外企 / 品牌设计师",
        logo: "./portfolio/career-topsports.jpg",
        responsibilities:
        ...
        moreDetails:
          "覆盖界面、活动营销、线下门店与城市终端，以可复用的设计规范支持大规模物料生产，在高频活动节奏中保障全国渠道的一致性与执行效率。",
      },
    ],
  },
  projects: {
